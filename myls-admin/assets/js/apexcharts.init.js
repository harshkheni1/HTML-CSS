...
options = {
    ...
    series: [74, 1, 15, 3, 2, 4],
    labels: ["Patel Pranjan", "Gogoi Akika", "Dadhania Harsh", "Gadhiya Mitul", "Kothari Urvish", "V Shivag"],
    colors: ["#FE55FE", "#55FEFE", "#FE5555", "#5555FE", "#55FE55", "#FEFE55"],
    legend: { show: !0, position: "right", horizontalAlign: "center", verticalAlign: "middle", floating: !1, fontSize: "14px", offsetX: 0, offsetY: -10 },
    responsive: [{ breakpoint: 600, options: { chart: { height: 240 }, legend: { show: !1 } } }],
};
(chart = new ApexCharts(document.querySelector("#attorneys_chart"), options)).render();

options = {
    chart: { height: 280, type: "pie" },
    series: [48, 1, 3, 9, 19, 1, 15, 2, 1],
    labels: ["Patel Pranjan","Jogani Hardik", "Gogoi Akika", "Dadhania Harsh", "Gadhiya Mitul","Personal id Poonam", "V Shivag", "Ramakrishnan Srinivasan", "Testing Acct Poonam" ],
    colors: ["#FEAEAE", "#818181", "#C00000", "#FE5555", "#5555FE", "#55FE55", "#FEFE55", "#FE55FE", "#55FEFE"],
    legend: { show: !0, position: "right", horizontalAlign: "center", verticalAlign: "middle", floating: !1, fontSize: "14px", offsetX: 0, offsetY: -10 },
    responsive: [{ breakpoint: 600, options: { chart: { height: 240 }, legend: { show: !1 } } }],
};
(chart = new ApexCharts(document.querySelector("#paralegals_chart"), options)).render();
options = {
    chart: { height: 280, type: "pie" },
    series: [50, 15, 15, 20],
    labels: ["Patel Pranjan", "Gogoi Akika", "Dadhania Harsh", "Kothari Urvish"],
    colors: ["#55D8FE", "#FF8373", "#A3A0FB", "#FFDA83"],
    legend: { show: !0, position: "right", horizontalAlign: "center", verticalAlign: "middle", floating: !1, fontSize: "14px", offsetX: 0, offsetY: -10 },
    responsive: [{ breakpoint: 600, options: { chart: { height: 240 }, legend: { show: !1 } } }],
};
(chart = new ApexCharts(document.querySelector("#attorneys_mycases"), options)).render();
...
(chart = new ApexCharts(document.querySelector("#paralegals_mycases"), options)).render();
// var chart;
// options = {
